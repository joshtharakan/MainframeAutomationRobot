...
{
     public class EhlApiImpl : EhlApi
    {
        
        static IntPtr ehlPtr = (IntPtr)100;
        static string sessionName = SettingsManager.Default.SessionName;
        //static string sessionName = "A";
        public EhlApiImpl()
        {
            SetSessionParams();
        }
         Boolean GetConnection()
        {
            ...
            catch (EhlApiError error)
            {
                ...
                Log.LogWriter.LogWrite("Unable to connect");
 ...
 //               System.Console.WriteLine("Copy to PS");
        ...
        public Boolean ExecuteCommand(String command,String expectedMenu)
        {
            try
            {
                ...
                System.Console.WriteLine("Execute Command: "+command.ToString());
                Log.LogWriter.LogWrite("Execute Command: " + command.ToString());
