// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModernUserControl.cs" company="Allianz">
...
namespace AZUK.MainframeAutomationRobot.Controls
{
    /// <summary>
    /// Class ModernUserControl.
    /// </summary>
    public class ModernUserControl : UserControl, IContent
    {
        ...
        public void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            //}
            string screenName = ScreenHandler.returnScreenName(e.Source);
            if (screenName == "")
                screenName = this.Name;

            ViewModelLocator vm = Application.Current.FindResource("Locator") as ViewModelLocator;
            this.DataContext = vm.GetCurrentViewModel(screenName);
